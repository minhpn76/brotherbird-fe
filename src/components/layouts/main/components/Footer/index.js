...
function Footer() {
  const footers = [
    ...
    { label: 'POWERED BY SHOPIFY', value: 'powerByShopify', link: '#' },
  ]
  return (
    <section className="footer">
      <Container>
        ...
        <Row>
          <Col md={{span: 4, offset: 4}} className="social">
              <a href="http://instagram.com/brotherbird_bakehouse" target="_blank">
